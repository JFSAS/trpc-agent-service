    ...
    def test_sdk_protocol_original_reply_and_redacted_evidence(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            try:
                ...
                self.assertTrue(request("setWebhook", {"url": "https://127.0.0.1:8080/v1/telegram/account", "secret_token": fixture.secret})["result"])
                self.assertEqual(request("getWebhookInfo", {})["result"]["url"], "https://127.0.0.1:8080/v1/telegram/account")
