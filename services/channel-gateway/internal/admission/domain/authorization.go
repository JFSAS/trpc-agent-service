...
func (a AdmissionAuthorization) ValidateFor(in Inbound, route RouteSnapshot) error {
	...
	case "DENIED":
		switch a.Reason {
		case "ACCOUNT_DISABLED", "ACCESS_DENIED", "PRINCIPAL_UNKNOWN", "PRINCIPAL_REVOKED", "PRINCIPAL_NOT_ALLOWED", "CONVERSATION_NOT_ALLOWED", "OPERATION_NOT_ALLOWED", "POLICY_DEPENDENCY_DENIED":
		default:
			return ErrUnavailable
		}
	default:
