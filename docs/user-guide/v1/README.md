...
1. 打开管理员给你的控制台地址，例如本机演示地址 `http://127.0.0.1:13001`，在项目主页点击 **进入控制台**；也可直接访问 `/console`。
...
| 页面 / 路径 | 主要功能 | 你通常怎么操作 |
| --- | --- | --- |
| 项目主页 `/` | 公开介绍、教程与文档入口 | 阅读教程、查阅文档，或点击进入控制台 |
| 文档中心 `/docs` | 按任务查找教程与参考文档 | 选择主题，阅读站内文档 |
...
- 共覆盖 **26 个页面入口**，包括主页、文档中心、控制台入口、登录、改密、平台管理、租户、Agent、运行配置、部署、渠道及三个历史版本页。
