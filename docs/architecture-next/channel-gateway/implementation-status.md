...
- **目标工作树**：`trpc-agent-service-channel-gateway`，分支 `codex/channel-gateway`，基线 `bf107766`。
- **日期**：2026-09-05。
...
**2026-09-06 GCI 基础切片补充**：本树新增 Control 账户目录模型、共享 HTTP Schema 消费、
...
本次当前范围及尚未接线项见第 12 节；当前迁移文件为 0001–0008。
